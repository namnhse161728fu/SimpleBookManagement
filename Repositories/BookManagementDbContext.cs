...
public partial class BookManagementDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C2075760C632");
        ...
        {
            entity.HasKey(e => e.BookCategoryId).HasName("PK__BookCate__6347EC0476DE565E");
        ...
        {
            entity.HasKey(e => e.MemberId).HasName("PK__UserAcco__0CF04B181FFE2A8A");
